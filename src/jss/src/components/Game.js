...
var Game = function (_React$Component) {
    ...
    function Game(props) {
        ...
        wall.onerror = onError;
        skyImage.onerror = onError;
        groundImage.onerror = onError;
        playerImage.onerror = onError;
        playerLeftImage.onerror = onError;
        playerRightImage.onerror = onError;
        playerDieImage.onerror = onError;
        obstacleImage.onerror = onError;
    ...
    _createClass(Game, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement('canvas', {
                id: 'canvas', ref: function ref(_ref) {
